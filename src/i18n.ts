...
const T: Record<string, [string, string]> = {
  ...
  // ── MappingEditor ────────────────────────────────────────
  meMappingCardTitle: ['Productsoort — koppelingen',    'Productsoort Mappings'],
  meMappingCardDesc:  [
    'Pas aan hoe elk productsoort wordt vertaald naar Artikelgroep en Eenheid. Wijzigingen worden automatisch in de browser opgeslagen. Exporteer als JSON om ze mee te nemen naar een andere laptop.',
    'Customise how each product type maps to Artikelgroep and Eenheid. Changes are auto-saved in the browser. Export as JSON to carry them to another device.',
  ],
  meApplySession:     ['Toepassen voor sessie',           'Apply for session'],
  meSave:             ['Opslaan in browser',              'Save to browser'],
  meResetAll:         ['Alles herstellen',                'Reset to defaults'],
  meResetBuiltIns:    ['Ingebouwde aanpassingen herstellen', 'Reset built-in overrides'],
  meDeleteCustom:     ['Eigen toevoegingen verwijderen',  'Delete custom entries'],
  meExport:           ['↓ Exporteren (.json)',            '↓ Export (.json)'],
  meImport:           ['↑ Importeren (.json)',            '↑ Import (.json)'],
  meImportErr:        ['Ongeldig bestand — verwacht een JSON-bestand dat eerder via Exporteren is aangemaakt.', 'Invalid file — expected a JSON file previously created via Export.'],
  meSearch:           ['Zoeken…',                        'Search…'],
  meAddNew:           ['Nieuwe toevoegen',               'Add new'],
  meNewProductsoort:  ['Nieuw productsoort…',            'New product type…'],
  meAdd:              ['Toevoegen',                      'Add'],
  meArtikelgroepCol:  ['Artikelgroep',                   'Article group'],
  meEenheidCol:       ['Eenheid',                        'Unit'],
  meStatusCol:        ['Status',                         'Status'],
  meBuiltIn:          ['Ingebouwd',                      'Built-in'],
  meCustomBadge:      ['Aangepast',                      'Custom'],
  meCustom:           ['aangepaste koppeling(en)',        'custom mapping(s)'],
  meUnknown:          ['Onbekend',                        'Unknown'],
  meReset:            ['Herstel',                        'Reset'],
  meDelete:           ['Verwijder',                      'Delete'],
  meFileValuesTitle:  ['Productsoorten in dit bestand',  'Product types in this file'],
  meShowAll:          ['▼ Alle koppelingen beheren',      '▼ Manage all mappings'],
  meHideAll:          ['▲ Alle koppelingen verbergen',    '▲ Hide all mappings'],
